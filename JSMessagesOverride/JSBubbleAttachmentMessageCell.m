...
@interface JSBubbleAttachmentMessageCell()
...
@implementation JSBubbleAttachmentMessageCell
                   ...
                   avatar:(BOOL)hasAvatar
{
    ...
    JSBubbleAttachmentView *bubbleView = [[JSBubbleAttachmentView alloc] initWithFrame:frame
                                                        bubbleType:type
...
- (void)prepareForReuse
{
    ...
    self.bubbleView.attachmentImageView.image = nil;
...
- (void)setAttachmentImage:(id)image {
    self.bubbleView.attachmentImageView.image = image;
}
                                                ...
                                                avatar:(BOOL)hasAvatar
{
    ...
    CGFloat bubbleHeight = 60+subviewHeights;
