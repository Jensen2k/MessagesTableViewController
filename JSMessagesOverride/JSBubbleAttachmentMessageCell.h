 ...
 */
@interface JSBubbleAttachmentMessageCell : JSBubbleMessageCell
 ...
 */
@property (weak, nonatomic, readonly) JSBubbleAttachmentView *bubbleView;
 ...
 *  @param message An object that conforms to the `JSMessageData` protocol containing the message data for the cell.
 */
- (void)setMessage:(id<JSMessageData>)image;
