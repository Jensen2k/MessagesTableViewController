...
#import "JSBubbleTapGestureRecognizer.h"
 ...
 */
@interface JSBubbleAttachmentView : JSBubbleView
...
/**
 *  Returns the UITapGestureRecognizer for the view
 */
@property (strong, nonatomic) JSBubbleTapGestureRecognizer *tapGestureRecognizer;
 ...
 */
@property (weak, nonatomic, readonly) UIImageView *attachmentImageView;
 ...
 */
+ (CGFloat)neededHeightForImageView:(UIImageView *)imageView;
