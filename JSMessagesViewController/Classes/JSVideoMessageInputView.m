//
//  JSVideoMessageInputView.m
//  JSMessagesDemo
//
//  Created by Martin Jensen on 14.02.14.
...
@interface JSVideoMessageInputView ()
...
@implementation JSVideoMessageInputView
...
- (void)configureInputBarWithStyle:(JSMessageInputViewStyle)style
{
    ...
    CGFloat attachmentButtonWidth = 45.0f;
    
    CGFloat width = self.frame.size.width - sendButtonWidth - attachmentButtonWidth;
    CGFloat height = [JSVideoMessageInputView textViewLineHeight];
    ...
    if (style == JSMessageInputViewStyleClassic) {
        ...
        _textView.frame = CGRectMake(49.0f, 4.5f, width, height);
    ...
    attachmentButton.frame = CGRectMake(4.0f, 4.0f, 42.0f, height);
    [attachmentButton setImage:[UIImage imageNamed:@"attach_camera"] forState:UIControlStateNormal];
...
- (void)adjustTextViewHeightBy:(CGFloat)changeInHeight
{
    ...
    [self.textView removeObserver:self.textView.keyboardDelegate
    ...
    [self.textView addObserver:self.textView.keyboardDelegate
                    forKeyPath:@"contentSize"
